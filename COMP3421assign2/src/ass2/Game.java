...
public class Game extends JFrame implements GLEventListener, KeyListener {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Terrain terrain = LevelIO.load(new File("test6"));
	...
	public void initialiseTextures(GL2 gl) {
		...
		/*
		 * 
		 * //Zombie Textures String ZheadTexFileName =
		 * "src/ass2/zombieBody.bmp"; MyTexture ZheadTex = new
		 * MyTexture(gl,ZheadTexFileName,"bmp",true); String ZFaceTexFileName =
		 * "src/ass2/zombieFace.bmp"; MyTexture ZFaceTex = new
		 * MyTexture(gl,ZFaceTexFileName,"bmp",true); String ZBodyTexFileName =
		 * "src/ass2/zombieBody.bmp"; MyTexture ZBodyTex = new
		 * MyTexture(gl,ZBodyTexFileName,"bmp",true); //
		...
		myTerrain.setTextures(groundTexture, treeTopTexture, treeTrunkTexture, roadTexture, faceTex, headTex, bodyTex,
				ATex, BTex);
	...
	public void cameraSetting(GLAutoDrawable drawable) {
		...
		if (FPcamera) {
			...
			gl.glTranslated(0, -(Terrain.altitude(myTerrain.getsize().width - Game.positionX,
					myTerrain.getsize().height - Game.positionZ) + 1), 0);
		} else {
			gl.glTranslated(0, 0, -20);
			gl.glRotated(angle + 45, 1, 0, 0);
			gl.glRotated(angle2, 0, 1, 0);
			// gl.glTranslated(0,
			// -(Terrain.altitude(10-Game.positionX,10-Game.positionZ)), 0);
	...
	public void Key() {
		...
		myTerrain.setPosition(Game.positionX - myTerrain.getsize().width, 0,
				Game.positionZ - myTerrain.getsize().height);
	}
}
