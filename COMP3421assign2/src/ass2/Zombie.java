...
public class Zombie extends GameObject {
	...
	/*
	 * public void setTextures(MyTexture faceTex, MyTexture headTex, MyTexture
	 * bodyTex){ //System.out.println("zom tex"+ headTex.getTextureId());
	 * myHead.setTextures(faceTex, headTex); myArmleft.setTextures(bodyTex,
	 * bodyTex); myArmright.setTextures(bodyTex, bodyTex);
	 * myTorso.setTextures(bodyTex, bodyTex); mylegleft.setTextures(bodyTex,
	 * bodyTex); mylegright.setTextures(bodyTex, bodyTex); }
	 */
